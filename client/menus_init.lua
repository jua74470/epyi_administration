...
if Config.MenuStyle.BannerStyle.ImageUrl ~= nil then
	...
	local Texture = CreateRuntimeTextureFromDuiHandle(
		runtimeTXD,
		"custom_menu_header",
		objectTexture
	)
...
function openMenu()
	...
	ESX.TriggerServerCallback(
		"epyi_administration:getPlayerGroup",
		function(group)
			-- Save player group
			...
			while _var.menus.admin.isOpened do
				...
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_personnal_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_personnal_appearance_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_players_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_players_interact_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_vehicles_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_vehicles_current_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_vehicles_current_custom_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_vehicles_favorites_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_vehicles_spawn_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_reports_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_reports_edit_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				...
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_server_bans_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
				RageUI.IsVisible(
					...
					Config.MenuStyle.BannerStyle.UseInstructionalButtons,
					function()
						main_server_bans_details_showContentThisFrame(
							_var.client.staffGroup
						)
					end
				)
