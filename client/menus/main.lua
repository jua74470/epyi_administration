...
function main_showContentThisFrame(playerGroup)
    ...
    RageUI.ButtonWithStyle(_U("main_menu_access_players"), _U("main_menu_access_players_desc"), { RightLabel = "→" }, Config.Groups[playerGroup].Access["submenu_players_access"], function(_h, _a, _s) end, _var.menus.admin.objects.mainPlayers)
    ...
    RageUI.ButtonWithStyle(_U("main_menu_access_reports"), _U("main_menu_access_reports_desc"), { RightLabel = "→" }, Config.Groups[playerGroup].Access["submenu_reports_access"], function(_h, _a, _s) end, _var.menus.admin.objects.mainReports)
