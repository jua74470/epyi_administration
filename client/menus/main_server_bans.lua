...
function main_server_bans_showContentThisFrame(playerGroup)
    ...
    RageUI.ButtonWithStyle(_U("search"), _U("main_server_bans_filter_desc"), { RightLabel = (_var.menu.bansFilter ~= "" and _var.menu.bansFilter or _U("no_filter")) }, true, function(_h, _a, Selected)
        if Selected then
