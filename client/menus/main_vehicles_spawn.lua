...
function main_vehicles_spawn_showContentThisFrame(playerGroup)
    RageUI.ButtonWithStyle(_U("main_vehicles_spawn_search"), _U("main_vehicles_spawn_search_desc"), { RightLabel = (_var.menu.searchVehicle ~= "" and "~r~" .. _var.menu.searchVehicle or "→") }, true, function(_h, _a, Selected)
        if Selected then
