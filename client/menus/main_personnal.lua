...
function main_personnal_showContentThisFrame(playerGroup)
    ...
    RageUI.Checkbox(_U("main_personnal_noclip"), _U("main_personnal_noclip_desc"), _threads.noclip.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_noclip"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_godmode"), _U("main_personnal_godmode_desc"), _threads.godmode.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_godmode"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_invisibility"), _U("main_personnal_invisibility_desc"), _threads.invisibility.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_invisibility"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_fastwalk"), _U("main_personnal_fastwalk_desc"), _threads.fastwalk.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_fastwalk"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_fastswim"), _U("main_personnal_fastswim_desc"), _threads.fastswim.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_fastswim"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_superjump"), _U("main_personnal_superjump_desc"), _threads.superjump.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_superjump"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_stayinvehicle"), _U("main_personnal_stayinvehicle_desc"), _threads.stayinvehicle.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_stayinvehicle"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_seethrough"), _U("main_personnal_seethrough_desc"), _threads.seethrough.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_seethrough"] }, function() end, function()
    ...
    RageUI.Checkbox(_U("main_personnal_shownames"), _U("main_personnal_shownames_desc"), _threads.shownames.isActivated, { Enabled = Config.Groups[playerGroup].Access["submenu_personnal_shownames"] }, function() end, function()
