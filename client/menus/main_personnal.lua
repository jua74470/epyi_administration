...
function main_personnal_showContentThisFrame(playerGroup)
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_noclip"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_godmode"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_invisibility"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_fastwalk"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_fastswim"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_superjump"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_stayinvehicle"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_seethrough"]
			then
				return
			end
	...
	RageUI.Checkbox(
		...
		function()
			if
				not Config.Groups[playerGroup].Access["submenu_personnal_shownames"]
			then
				return
			end
