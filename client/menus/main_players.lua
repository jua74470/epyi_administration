...
function main_players_showContentThisFrame(playerGroup)
    ...
    RageUI.ButtonWithStyle(_U("search"), _U("main_players_filter_desc"), { RightLabel = (_var.menu.playersFilter ~= "" and _var.menu.playersFilter or _U("no_filter")) }, true, function(_h, _a, Selected)
        if Selected then
