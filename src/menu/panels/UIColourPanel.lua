		...
		if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
			...
			RenderText(
				(Title and Title or "")
					...
					.. ")",
				CurrentMenu.X
					+ RageUI.Settings.Panels.Grid.Text.Top.X
					+ (CurrentMenu.WidthOffset / 2),
				CurrentMenu.Y
			...
			if
				(Hovered or LeftArrowHovered or RightArrowHovered)
				and RageUI.Settings.Controls.Click.Active
			then
