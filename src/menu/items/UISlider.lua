			...
			then
				...
				if Enabled == true or Enabled == nil then
					if Selected then
						...
						then
							...
							RightOffset =
								MeasureStringWidth(Style.RightLabel, 0, 0.35)
						end
					else
						if
							Style.RightLabel ~= nil
				...
				if type(Style) == "table" then
					if Style.Enabled == true or Style.Enabled == nil then
							...
							if Style.LeftBadge ~= nil then
								...
								then
									...
									RenderSprite(
										...
										0,
										BadgeData.BadgeColour
												and BadgeData.BadgeColour.R
											or 255,
										BadgeData.BadgeColour
												and BadgeData.BadgeColour.G
											or 255,
										BadgeData.BadgeColour
												and BadgeData.BadgeColour.B
											or 255,
										BadgeData.BadgeColour
												and BadgeData.BadgeColour.A
											or 255
									)
								end
							end
						...
						if
							LeftBadge ~= RageUI.BadgeStyle.None
							and LeftBadge ~= nil
						then
				...
				if
					...
					and not (
						...
						or (
							CurrentMenu.Controls.Click.Active
							and RightArrowHovered
						)
					)
				then
						...
						(
							(
								...
								or (
									...
									and (
										not LeftArrowHovered
										and not RightArrowHovered
									)
								)
							) and Selected
						),
